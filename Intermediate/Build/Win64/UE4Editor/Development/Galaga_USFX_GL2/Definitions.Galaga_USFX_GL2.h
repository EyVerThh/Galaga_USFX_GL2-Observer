...
#define UE_PROJECT_NAME Galaga_USFX_GL2
#define UE_TARGET_NAME Galaga_USFX_GL2Editor
#define UE_MODULE_NAME "Galaga_USFX_GL2"
...
#define GALAGA_USFX_GL2_API DLLEXPORT
